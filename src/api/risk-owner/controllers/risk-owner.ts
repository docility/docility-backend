...
/**
 * risk-owner controller
 */

import { factories } from '@strapi/strapi';

export default factories.createCoreController('api::risk-owner.risk-owner', ({ strapi }) => ({
  async find(ctx) {
    ...
    const suppliers = await strapi.entityService.findMany('api::risk-owner.risk-owner', {
