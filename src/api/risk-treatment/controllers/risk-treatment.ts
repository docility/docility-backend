...
export default factories.createCoreController('api::risk-treatment.risk-treatment', ({ strapi }) => ({
  async find(ctx) {
    ...
    const suppliers = await strapi.entityService.findMany('api::risk-treatment.risk-treatment', {
