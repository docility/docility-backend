...
export default factories.createCoreController('api::customer-category.customer-category', ({ strapi }) => ({
  async find(ctx) {
    ...
    const suppliers = await strapi.entityService.findMany('api::customer-category.customer-category', {
