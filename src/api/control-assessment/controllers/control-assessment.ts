...
export default factories.createCoreController('api::control-assessment.control-assessment', ({ strapi }) => ({
  async find(ctx) {
    ...
    const suppliers = await strapi.entityService.findMany('api::control-assessment.control-assessment', {
