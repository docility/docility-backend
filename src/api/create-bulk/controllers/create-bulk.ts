...
module.exports = {
    ...
    try {
      ...
      setImmediate(async () => {
        try {
          ...
          emitMessageToClient(strapi, parseInt(userId), "message", {
            type: "info",
  ...
  createSupplier: async (ctx) => {
    ...
    try {
      ...
      ctx.body = {
        message:
          "Supplier creation has been initiated. The process is running in the background.",
      };
  ...
  createCustomers: async (ctx) => {
    ...
    try {
      ...
      ctx.body = {
        message:
          "Customers creation has been initiated. The process is running in the background.",
      };
  ...
  createCompany: async (ctx) => {
    ...
    try {
      ...
      ctx.body = {
        message:
          "Company creation has been initiated. The process is running in the background.",
      };
